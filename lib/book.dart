...
rate: 4.3,
page: 229,
categoryBook: 'Sysadmin IDN', language: 'IDN'),
Book(
      name: 'Docker',
image: 'images/buku-docker.png', description:
'Docker adalah sekumpulan platform sebagai produk layanan yang menggunakan virtualisasi tingkat OS untuk mengirimkan perangkat lunak dalam paket yang disebut kontainer.', rate: 4.2,
page: 210,
categoryBook: 'Sysadmin IDN',
language: 'IDN'),
Book(
name: 'Hyper-V',
image: 'images/buku-hyper-v.png', description:
...
Book(
      name: 'VPN',
image: 'images/buku-vpn.png', description:
...
rate: 4.4,
page: 210,
categoryBook: 'Network IDN', language: 'IDN'),
Book(
name: 'Openstack',
image: 'images/buku-openstack-admin.png', description:
